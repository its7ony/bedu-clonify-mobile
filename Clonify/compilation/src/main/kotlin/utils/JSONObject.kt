...
class JSONObject {
    private var mapa: LinkedHashMap<String, Any?>
    ...
    fun removeExcept(nome: Collection<String>):  LinkedHashMap<String, Any?> {
        mapa = mapa.filterKeys { it in nome.toSet() } as LinkedHashMap<String, Any?>
        return mapa
    }

...
private fun obtenerListaDeArtistas():List<Artista>{
    return listOf(
        Artista(
            "James", " Hedflield", "Nose ", 65, "Masculino",
            "Metallica",
            listOf(
                Album(
                    1, "Kill 'Em All", "Trash Metal", 1983,
                    listOf(
        ...
        ), Artista("Ludovico", "Einaudi","Aldrovandi",65,"Clasica","Ludovico Einaudi",
            listOf(
                Album(
                    1,"Divenire","Clasica",2004,
                    listOf(Cancion(1,"Divenire","6:35","letra"),
                        Cancion(2,"Una Mattina","5:34","letra")
                    )
                )
            )d
        )
